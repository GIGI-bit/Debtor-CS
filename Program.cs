...
class Program
{
    ...
    static void Main()
    {
       ...
       //new Debtor("Malie K. Peanut",DateTime.Parse("August 21 1988"),"827-104-365","MalieKPeanut@gmail.com","2221 Backer Street London",1324)
        };

        //2) rhyta.com ve ya dayrep.com domenlerinde emaili olan borclulari cixartmag

        //var list= debtors.Where(debtor=>(debtor.Email.Contains("rhyta.com")|| debtor.Email.Contains("dayrep.com")));
        ...
        //var list=debtors.Where(debtor => (2032 - debtor.BirthDay.Year) > 26 && (2032 - debtor.BirthDay.Year) < 36);
        ...
        //var list = debtors.Where(debtor => debtor.Debt < 5000);
        ...
        //var list = debtors.Where(
        //    debtor =>(debtor.FullName.Length>18)&&(debtor.Phone.Count(c=>c=='7')>2));
        //foreach (var item in list)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //var list = debtors.Where(debtor => (debtor.BirthDay.Month == 12) || (debtor.BirthDay.Month ==1 )||( debtor.BirthDay.Month ==2));
        ...
        //string splitString(string name)//9-cu tapsiriqda error almamaq ucun bu funksiyani kommentden cixarin.
        //{
        //    string newName = name;
        //    int index = name.IndexOf(". ");
        //    return name.Substring(index + 2);
        //}
        //var list=debtors.Where(debtor=>(debtor.Debt>debtors.Average(debtor=>debtor.Debt))).OrderBy(debtor=>splitString(debtor.FullName)).OrderByDescending(debtor=>debtor.Debt).ToList();
        //foreach (var item in list)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //foreach (var item in list)
        //{
        //    Console.WriteLine(splitString(item.FullName)+ " "+(DateTime.Now.Year - item.BirthDay.Year)+" "+item.Debt);
        //}
        ...
        //var list = debtors.OrderByDescending(debtor =>LetterCounter(debtor.FullName)>=3).OrderBy(debtor=>debtor.FullName).ToList();
        //foreach (var item in list)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //List<Debtor> list = debtors.OrderByDescending(debtor=>debtor.Debt).Take(5).ToList();
        //foreach (var item in list)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //int cem = debtors.Sum(debtor => debtor.Debt);
        //Console.WriteLine(cem);

        //16)2ci dunya muharibesin gormush borclularin siyahisi cixartmaq
        //List<Debtor>list=debtors.Where(debtor=>(debtor.BirthDay.Year>=1941&&debtor.BirthDay.Year<=1945)).ToList();
        //foreach (var item in list)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //    return true;
        //}
        ////debtors list -indeki butun debtor-larin numrelerinde reqemler tekrarlandigi ucun sona yeni debtor elave etdim kodu run etmezden evvel o debtoru kommentden cixarin
        //var list=debtors.Where(debtor=>NumberCheck(debtor.Phone)).ToList();
        //foreach (var item in list)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //List<Debtor> list = debtors.Where(debtor => ((DateTime.Now.Month - debtor.BirthDay.Month) * 6000) > debtor.Debt).ToList();
        //foreach (var item in list)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //List<Debtor> list = debtors.Where(debtor => 
